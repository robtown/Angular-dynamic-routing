...
const routes: Routes = [
  ...
  { path: 'Q1', component: Question1, data: { state: 'Q1'} },
  { path: 'Q2', component: Question2, data: { state: 'Q2'} },
  { path: 'Q3', component: Question3, data: { state: 'Q3'} },
  { path: 'Q4', component: Question4, data: { state: 'Q4'} },
  { path: 'Q5', component: Question5, data: { state: 'Q5'} },
  { path: 'Q6', component: Question6, data: { state: 'Q6'} },
  { path: 'Results', component: Results, data: { state: 'Results'} },
];
